...
public class Consultar {
	...
	public Consultar() {
		try {
			manager = Util.conectarBanco();  // TERCEIRA CONSULTA USA FILTER
			
			System.out.println("consultas... \n");
			System.out.println("\nAlugueis de carro palio ordenados por valor");
			Query q;
			q = manager.query();
			q.constrain(Aluguel.class);
			q.descend("carro").descend("modelo").constrain("palio");  //condi��o
